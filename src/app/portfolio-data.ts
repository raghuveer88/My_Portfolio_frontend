...
export const PORTFOLIO = {
  ...
  {
    company: 'ADP, Inc.',
    role: 'Member Technical — Software Engineering',
  ...
  {
    company: 'Clarivate',
    role: 'Software Engineer Intern — ML Engineering',
  ...
  projects: [
    {
    name: 'Asset AI (Property Analytics Assistant)',
    date: '2025',
    description:
      'Built a property-specific AI assistant that processes 107,000+ rent-roll records across 25 properties and combines structured analytics with RAG over 139 property website pages. Implemented 15+ OpenAI tool-calling workflows, property-scoped retrieval over 325 indexed chunks, and an Angular dashboard for occupancy, vacancy, balances, lease risk, KPI cards, tables, and charts.',
    technologies: [
      'Python',
      'FastAPI',
      'Angular',
    ...
    award: 'Personal Project',
    image: 'assets/files/rag_img.png',
  ...
  },
  {
    ...
    image: 'assets/files/fine_tune_llm.png',
  ...
  },
  {
    ...
    image: 'assets/files/jokes_meet_ai.png',
  ...
  },
  {
    ...
    image: 'assets/files/student_faculty_form.png'
  },
  {
    ...
    award: 'Campus Project',
    image: 'assets/files/bike_rental.png'
  },
  {
    name: 'Hybrid DASH + P2P Video Delivery',
    date: '2025',
    image: 'assets/files/dash.png',
    description:
  ...
  },
  {
    name: 'Shell in C',
    date: '2025',
    image: 'assets/files/shell_in_c.png',
    description:
  ...
  },
  {
    ...
    date: '2019',
    image: 'assets/files/cricket_world_cup.png',
    description:
